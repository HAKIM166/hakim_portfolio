...
const info = [
  ...
  },
  {
    icon: <FaMapMarkerAlt />,
    title: "Address",
    description: "Manfalut, Assiut, Egypt",
  },
];
          ...
          <div className="xl:w-[54%] order-2 xl:order-none">
            ...
            >
              ...
              <p className="text-white/60">Lorem ipsum dolor sit amet consectetur 
                adipisicing elit. Corrupti eum sunt ut explicabo similique.</p>
                {/* input */}
                ...
                <Select>
                  <SelectTrigger className="w-full">
                    <SelectValue placeholder="Sale a service"/>
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup>
